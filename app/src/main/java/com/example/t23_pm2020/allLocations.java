...
public class allLocations extends Fragment {
    ...
    private AllLocationsViewModel mViewModel;
    private boolean IsManager=false;
    private boolean IsLogged = false;
    public ArrayList<location> locationsList = new ArrayList<>();

    public static allLocations newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.all_locations_fragment, container, false);
        final RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.all_locations_list);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AllLocationsViewModel.class);
